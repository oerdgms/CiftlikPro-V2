...
/* 6.18 DESKTOP UX — web dashboard yerine masaüstü ERP hissi */
html,body{{height:100%}}
body.desktop-app{{background:#eef2ef;overflow-x:hidden;padding-bottom:28px}}
body.desktop-app .top{{height:38px;background:#fbfcfb;color:#17251c;border-bottom:1px solid #d7dfd9;padding:0 14px;box-shadow:none;z-index:60}}
body.desktop-app .top-left{{gap:8px}}.brand-mark{{font-size:15px}}.desktop-app .brand{{font-size:14px;color:#15251b;display:flex;align-items:center;gap:7px}}.app-separator{{color:#9aa7a0}}.app-version{{font-size:12px;color:#44564b}}
.desktop-app .top-user{{display:flex;align-items:center;gap:4px;height:100%;font-size:12px}}.desktop-app .top-action,.desktop-app .logout-link{{padding:7px 9px;border-radius:4px;color:#23372a}}.desktop-app .top-action:hover,.desktop-app .logout-link:hover{{background:#e9eeea}}.user-chip{{padding:6px 10px;border-left:1px solid #dde4df;margin-left:3px;font-weight:700}}
.desktop-app .commandbar{{position:fixed;left:0;right:0;top:38px;height:48px;background:#fff;border-bottom:1px solid #dce4de;z-index:55;display:flex;align-items:center;padding:0 14px 0 212px;gap:2px;box-shadow:0 1px 4px #10271b0d}}
.desktop-app .commandbar a{{height:34px;display:flex;align-items:center;padding:0 12px;border-radius:5px;font-size:12px;font-weight:650;color:#21352a}}.desktop-app .commandbar a:hover{{background:#edf4ef;color:#0f6b3a}}.command-spacer,.status-spacer{{flex:1}}.command-status{{font-size:11px;color:#36744e}}
.desktop-app .workspace-tabs{{position:fixed;left:198px;right:0;top:86px;height:36px;background:#f4f6f4;border-bottom:1px solid #d8e0da;z-index:50;display:flex;align-items:end;padding:0 10px;gap:10px}}.workspace-tab{{height:31px;min-width:150px;max-width:360px;background:#fff;border:1px solid #d8e0da;border-bottom-color:#fff;border-radius:6px 6px 0 0;padding:7px 12px;font-size:12px;font-weight:750;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}}.workspace-tab.active{{box-shadow:inset 0 2px 0 #18864b}}.workspace-hint{{font-size:11px;color:#748278;padding-bottom:8px}}
.desktop-app .layout{{padding-top:122px}}.desktop-app .side{{top:38px;width:198px;padding:58px 8px 34px;background:linear-gradient(180deg,#075f35,#064b2c);box-shadow:1px 0 0 #dbe3dd}}.desktop-app .main{{margin-left:198px;padding:12px 14px 20px;min-height:calc(100vh - 150px)}}
.side-brand-mini{{position:absolute;top:12px;left:13px;color:#fff;font-size:13px;font-weight:900;letter-spacing:.9px;opacity:.95}}.desktop-app .side a,.desktop-app .nav-group summary{{padding:8px 10px;border-radius:5px;margin:2px 0;font-size:12px}}.desktop-app .nav-group{{margin:2px 0}}.desktop-app .nav-group summary{{font-size:12px}}.desktop-app .nav-children{{margin-left:9px}}.desktop-app .side .nav-children a{{padding:7px 9px;font-size:11.5px}}.side-collapse{{position:fixed;left:0;bottom:28px;width:198px;padding:8px 12px;color:#d8f0e1;border-top:1px solid #ffffff1f;font-size:11px}}
.desktop-app .card{{border-radius:7px;padding:12px;box-shadow:none;border:1px solid #dce5df}}.desktop-app .grid{{gap:8px}}.desktop-app table{{border-radius:5px}}.desktop-app th,.desktop-app td{{padding:8px 9px;font-size:12px}}.desktop-app th{{background:#eaf1ec}}.desktop-app .btn{{border-radius:5px;padding:8px 11px;font-size:12px}}.desktop-app input,.desktop-app select,.desktop-app textarea,.desktop-app .form input,.desktop-app .form select,.desktop-app .form textarea{{border-radius:5px}}.desktop-app h1{{font-size:22px;margin:8px 0 12px}}.desktop-app h2{{font-size:16px}}.desktop-app h3{{font-size:14px}}
.desktop-app .target-compare-sticky,.desktop-app .workbench-shell,.desktop-app .perf-filter-card{{border-radius:7px!important;box-shadow:none!important}}.desktop-app .nutri-mini,.desktop-app .nutri-compare-card{{border-radius:6px!important}}.desktop-app .ration-workbench-table{{border:1px solid #dce4df}}.desktop-app .ration-stepper .ration-qty{{border-radius:5px}}
.statusbar{{position:fixed;left:0;right:0;bottom:0;height:28px;background:#f8faf8;border-top:1px solid #d5ded8;z-index:80;display:flex;align-items:center;gap:22px;padding:0 12px;font-size:10.5px;color:#526158}}.statusbar span:first-child,.statusbar span:nth-child(2){{color:#237447}}

/* 6.19 Desktop ERP density pass — visual shell only, solver untouched */
.desktop-app .top{height:34px}.desktop-app .commandbar{top:34px;height:54px;padding-left:210px;border-bottom-color:#cfd9d2}.desktop-app .commandbar a{height:42px;min-width:74px;justify-content:center;flex-direction:column;gap:1px;padding:3px 12px;font-size:11px}.desktop-app .workspace-tabs{top:88px;height:34px}.desktop-app .layout{padding-top:122px}.desktop-app .side{top:34px;padding-top:64px}.desktop-app .main{padding:8px 10px 24px}.desktop-app .workbench-page-head{margin:0 0 5px}.desktop-app .workbench-page-head h1{font-size:18px!important;margin:5px 0 2px!important}.desktop-app .workbench-page-head p{font-size:11px;margin:0}.desktop-app .target-workspace{margin-top:5px}.desktop-app .target-controlbar{padding:6px 8px;border-radius:6px}.desktop-app .target-compare-sticky{position:relative;top:auto;margin-top:5px;padding:5px;border-radius:6px}.desktop-app .nutri-mini-grid{grid-template-columns:repeat(4,minmax(145px,1fr))!important;gap:4px!important}.desktop-app .nutri-mini{min-height:58px!important;padding:5px 7px!important}.desktop-app .nutri-mini b{font-size:15px!important}.desktop-app #ration-workbench{margin-top:6px!important;padding:8px}.desktop-app .workbench-head{margin-bottom:2px}.desktop-app .workbench-head h3{font-size:14px!important}.desktop-app .ration-workbench-table th,.desktop-app .ration-workbench-table td{padding:4px 6px!important;line-height:1.15}.desktop-app .ration-workbench-table{font-size:11.5px}.desktop-app .ration-stepper input{height:28px!important}.desktop-app .ration-stepper button{min-height:28px!important;padding:3px 7px!important}.desktop-app .ration-savebar{position:sticky;bottom:25px;background:#f7faf8;border-top:1px solid #dbe5de;z-index:8}.desktop-app .card{padding:9px}.desktop-app .dashboard-hero{min-height:auto!important;padding:14px 18px!important}.desktop-app .dashboard-grid .card{min-height:82px!important}.desktop-app .statusbar{height:24px;font-size:10.5px}.desktop-app .side-collapse{bottom:24px}
@media(max-width:900px){{.desktop-app .commandbar{{padding-left:12px;top:64px;height:42px;overflow-x:auto}}.desktop-app .workspace-tabs{{display:none}}.desktop-app .layout{{padding-top:106px}}.desktop-app .side{{top:64px;width:260px;padding-top:18px}}.desktop-app .main{{margin-left:0}}.side-brand-mini,.side-collapse{{display:none}}.statusbar{{display:none}}}}
...
</style></head><body class="desktop-app"><div class="top"><div class="top-left"><button class="menu-toggle" id="menuToggle" aria-label="Menüyü aç">☰</button><a class="brand" href="/" title="Ana Sayfa"><span class="brand-mark">🐄</span><span>ÇiftlikPro Enterprise</span></a><span class="app-separator">|</span><span class="app-version">{APP_LABEL}</span></div><div class="top-user"><a class="top-action" href="/reports">▤ Raporlar</a><a class="top-action" href="/version-notes">ⓘ Sürüm</a><span class="user-chip">{h(display)}</span><a class="logout-link" href="/logout">Çıkış</a></div></div><div class="commandbar"><a href="/animal-add">＋ Yeni Kayıt</a><a href="/rations">🧠 Rasyon</a><a href="/feeds">🌾 Yem Kataloğu</a><a href="/finance">₺ Finans</a><a href="/reports">▤ Raporlar</a><span class="command-spacer"></span><span class="command-status">● Sistem hazır</span></div><div class="workspace-tabs"><span class="workspace-tab active">{h(title)}</span><span class="workspace-hint">ÇiftlikPro çalışma alanı</span></div><div class="layout"><aside class="side" id="sideMenu"><div class="side-brand-mini">ÇİFTLİKPRO</div>{nav}<div class="side-collapse">‹‹ Menüyü Daralt</div></aside><main class="main">{fl}{body}</main></div><div class="statusbar"><span>● Durum: Hazır</span><span>● Veritabanı: Bağlı</span><span>ÇiftlikPro Enterprise</span><span class="status-spacer"></span><span>{APP_LABEL}</span></div><script>
(function(){{
