...
APP_VERSION='3.9.14'
APP_CHANNEL='DEV'
APP_LABEL='ENTERPRISE V3.9.14 · CANLI HEDEF + RASYON MASASI'
...
/* V3.9.14 - hedef çalışma masasıyla birlikte görünür */
